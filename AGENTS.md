...
*   **Package Management:** Use `npm` for running scripts and managing packages (note: while `bun` is preferred in principle, the current development environment uses `npm`).
*   **Content Generation:**
